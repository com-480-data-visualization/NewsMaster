...
export const importColorRangeWhite = ["#cce5ff", "#004db3"];
export const importColorRangeDark =  ["#0f2942", "#7cb3fb"];

export const exportColorRangeWhite = ["#e6fff0", "#2a8c57"];
export const exportColorRangeDark = ["#e6fff0", "#2a8c57"];
...
// Theme-aware color scale functions
export function createImportColorScale(isDark: boolean = false) {
  ...
  scale.domain = (newDomain?: [number, number]) => {
    if (newDomain) {
      domain = newDomain;
      return scale;
    }
...
export function createExportColorScale(isDark: boolean = false) {
...
// Default scales (light theme)
export const importColorScale = createImportColorScale(false);
export const exportColorScale = createExportColorScale(false);